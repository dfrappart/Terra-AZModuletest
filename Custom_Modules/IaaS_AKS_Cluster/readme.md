...
| <a name="input_AksCustomizedConfigEnabled"></a> [AksCustomizedConfigEnabled](#input\_AksCustomizedConfigEnabled) | A bool to Enable/Disable Azure Defender for Kubernetes through the azapi provider | `bool` | `false` | no |
...
| <a name="input_KubeletContainerLogMaxFiles"></a> [KubeletContainerLogMaxFiles](#input\_KubeletContainerLogMaxFiles) | Specifies the maximum number of container log files that can be present for a container. must be at least 2. Changing this forces a new resource to be created. | `string` | `null` | no |
...
| Name | Type |
|------|------|
| [azapi_update_resource.AksCustomize](https://registry.terraform.io/providers/azure/azapi/latest/docs/resources/update_resource) | resource |
