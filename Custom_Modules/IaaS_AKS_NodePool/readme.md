...
| <a name="input_AKSNodeOSSku"></a> [AKSNodeOSSku](#input\_AKSNodeOSSku) | The Operating System which should be used for this Node Pool. Changing this forces a new resource to be created. Possible values are Linux and Windows. Defaults to Linux. | `string` | `null` | no |
...
| <a name="input_NodePublicIpTags"></a> [NodePublicIpTags](#input\_NodePublicIpTags) | Specifies a mapping of tags to the instance-level public IPs. Changing this forces a new resource to be created. | `map` | `null` | no |
