...
| <a name="input_AMAAMAUaiId"></a> [AMAAMAUaiId](#input\_AMAAMAUaiId) | The identifier value for Azure Monitor Agent | `string` | `""` | no |
| <a name="input_AMAEnabled"></a> [AMAEnabled](#input\_AMAEnabled) | A bool to enable/disable Azure Monitor Agent | `bool` | `true` | no |
| <a name="input_AMAIdentifierName"></a> [AMAIdentifierName](#input\_AMAIdentifierName) | The identifier name for Azure Monitor Agent | `string` | `"WorkspaceId"` | no |
...
| <a name="input_CustomScriptSettings"></a> [CustomScriptSettings](#input\_CustomScriptSettings) | The command to launch in the custom script | <pre>object({<br/>    commandToExecute = optional(string, null)<br/><br/>  })</pre> | <pre>{<br/>  "commandToExecute": ""<br/>}</pre> | no |
...
| <a name="input_Dcr"></a> [Dcr](#input\_Dcr) | n/a | <pre>map(object({<br/>    DcrId          = string<br/>    DcrDescription = string<br/>  }))</pre> | `{}` | no |
| <a name="input_DefaultTags"></a> [DefaultTags](#input\_DefaultTags) | Define a set of default tags | `map(any)` | <pre>{<br/>  "CostCenter": "labtf",<br/>  "Country": "fr",<br/>  "Environment": "lab",<br/>  "ManagedBy": "Terraform",<br/>  "Project": "tfmodule",<br/>  "ResourceOwner": "That would be me"<br/>}</pre> | no |
...
| <a name="input_DisablePasswordAuthentication"></a> [DisablePasswordAuthentication](#input\_DisablePasswordAuthentication) | Specifies whether password authentication should be disabled for SSH. Defaults to false. | `bool` | `true` | no |
...
| <a name="input_SshPublicKey"></a> [SshPublicKey](#input\_SshPublicKey) | The SSH public key used to authenticate the admin user of the Virtual Machine. Must be in OpenSSH format. | `string` | `""` | no |
...
| <a name="input_UAIIds"></a> [UAIIds](#input\_UAIIds) | The ID of a user assigned identity. | `list(any)` | `[]` | no |
...
| <a name="input_VmAdminPassword"></a> [VmAdminPassword](#input\_VmAdminPassword) | The Password which should be used for the local-administrator on this Virtual Machine. Changing this forces a new resource to be created. | `string` | `null` | no |
...
| [azurerm_monitor_data_collection_rule_association.example1](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_data_collection_rule_association) | resource |
