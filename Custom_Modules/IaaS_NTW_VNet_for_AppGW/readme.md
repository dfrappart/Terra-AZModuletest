...
| <a name="input_ResourcePrefix"></a> [ResourcePrefix](#input\_ResourcePrefix) | Define the resource prexix, as define in the Cloud adoptio  framework. | `string` | `"rg"` | no |
| <a name="input_Rg"></a> [Rg](#input\_Rg) | An object containing the resource group to be created with it's location | <pre>object({<br>    Name     = string<br>    Location = string<br>    CreateRG = bool<br>  })</pre> | <pre>{<br>  "CreateRG": true,<br>  "Location": "eastus",<br>  "Name": ""<br>}</pre> | no |
| <a name="input_RgName"></a> [RgName](#input\_RgName) | The resource core name. Should follow the pattern dbaas-<env>-<tenant>-<instance>-<specificidentifyingstring> | `string` | `"unspecified"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_RGName"></a> [RGName](#output\_RGName) | The name of the RG in which the resources are located |
| <a name="output_Subnets"></a> [Subnets](#output\_Subnets) | n/a |
| <a name="output_diagNsg"></a> [diagNsg](#output\_diagNsg) | n/a |
| <a name="output_diagvnet"></a> [diagvnet](#output\_diagvnet) | n/a |
